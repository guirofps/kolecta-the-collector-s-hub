    ...
    <Layout>
      <div className="max-w-[860px] mx-auto px-4 py-12">
        ...
        <div className="mb-10">
          ...
          <Badge variant="outline" className="mt-2 text-xs">Versão 1.1</Badge>
        </div>
