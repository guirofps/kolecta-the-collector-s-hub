...
const sections = [
  ...
  { id: 'anuncios', title: '5. Anúncios e vendas', content: `O Vendedor é o único e exclusivo responsável pelo conteúdo de seus anúncios, incluindo descrições, fotos, preços e condições de venda. Os anúncios devem refletir fielmente as características do Produto ofertado.\n\nA Kolecta realiza moderação de anúncios e reserva-se o direito de rejeitar, suspender ou remover anúncios que violem estes Termos, contenham informações falsas ou enganosas, ou que se refiram a produtos proibidos pela legislação brasileira ou pelas políticas da Plataforma.\n\nAo concluir uma venda, o Vendedor obriga-se a enviar o Produto nas condições anunciadas e dentro do prazo informado. Nas vendas com envio, a própria Plataforma emite a etiqueta de postagem e a declaração de conteúdo e as disponibiliza ao Vendedor, cabendo a ele embalar e postar o Produto no prazo; o código de rastreamento é disponibilizado ao Comprador pela Plataforma. Na modalidade de retirada em mãos, aplicam-se as condições combinadas entre as partes. O não cumprimento destas obrigações poderá resultar em penalidades, incluindo suspensão da conta e retenção de valores.` },
  { id: 'pre-venda', title: '6. Pré-venda', content: `A Pré-venda permite ao Vendedor anunciar Produto que ainda não está em sua posse, desde que informe a data prevista de chegada. O Anúncio é identificado com a marcação "PRÉ-VENDA" no título e exibe a data prometida ao Comprador antes da compra.\n\nRegras aplicáveis:\n\n• A data prevista de chegada é obrigatória e limitada a 90 (noventa) dias contados da publicação do Anúncio.\n• O Comprador paga o valor integral no momento da compra. O valor permanece retido pela Plataforma e só é repassado ao Vendedor após a confirmação de entrega, nos mesmos termos das demais vendas.\n• O prazo de envio do Produto começa a contar a partir da data prevista informada no Anúncio, e não da data da compra.\n• O Vendedor é responsável por manter a data prevista atualizada. Havendo alteração do prazo, deverá comunicar o Comprador.\n\nNos termos do artigo 35 do Código de Defesa do Consumidor, caso o Vendedor não cumpra a oferta no prazo anunciado, o Comprador poderá, à sua escolha: (i) exigir o cumprimento forçado da obrigação; (ii) aceitar outro produto equivalente; ou (iii) rescindir o contrato, com direito à restituição integral da quantia paga, sem prejuízo de eventuais perdas e danos.\n\nO direito de arrependimento previsto no artigo 49 do Código de Defesa do Consumidor é contado a partir do recebimento do Produto, e não da data da compra.\n\nO descumprimento reiterado de prazos de Pré-venda poderá acarretar a suspensão do direito de publicar Anúncios nesta modalidade, sem prejuízo das demais penalidades previstas nestes Termos.` },
  { id: 'modo-lance', title: '7. Modo Lance', content: `O Modo Lance é a funcionalidade de leilão da Plataforma, onde Compradores podem dar lances em Produtos selecionados. As seguintes regras se aplicam:\n\n• Cada lance é irrevogável e vinculante. Ao dar um lance, o Comprador compromete-se a adquirir o Produto caso seja o vencedor.\n• O lance mínimo é definido pelo Vendedor no momento da criação do anúncio.\n• O prazo para pagamento após vencer o leilão é de 48 horas. O não pagamento no prazo resultará em penalidades e poderá acarretar suspensão da conta.\n• A Kolecta poderá intervir em leilões que apresentem comportamento suspeito, incluindo cancelamento de lances fraudulentos.\n• A extensão automática do leilão poderá ocorrer quando houver lances nos minutos finais, conforme configuração da Plataforma.\n• O shill bidding (prática de dar lances em seu próprio leilão) é expressamente proibido e resultará no banimento permanente.` },
  { id: 'pagamentos', title: '8. Pagamentos e taxas', content: `A Kolecta cobra comissão sobre cada venda realizada na Plataforma, conforme tabela de comissões vigente disponível em kolecta.com.br/taxas-e-comissoes. As taxas podem variar por categoria de produto e tipo de venda (preço fixo ou Modo Lance).\n\nOs pagamentos são processados por meio da Pagar.me, provedora de serviços de pagamento da Plataforma, pelos meios disponibilizados no checkout (como PIX e, quando habilitado, cartão de crédito). Para receber seus repasses, o Vendedor deverá concluir o cadastro de recebedor junto à Pagar.me, fornecendo os dados exigidos para verificação. O valor líquido da venda fica retido e é liberado ao Vendedor após a confirmação da entrega, respeitando o prazo de segurança definido pela Plataforma.\n\nA Kolecta não se responsabiliza por problemas relacionados ao processamento de pagamentos pela Pagar.me ou por instituições financeiras, incluindo chargebacks, estornos ou bloqueios de conta.` },
  { id: 'fundadores', title: '9. Programa de Membros Fundadores', content: `A Kolecta mantém o Programa de Membros Fundadores, uma condição promocional por tempo e vagas limitados destinada aos primeiros vendedores da Plataforma.\n\n• O programa contempla um número limitado de posições de Fundador, identificadas por numeração própria (por exemplo, #000 a #100), exibida no perfil do Vendedor por meio de selo.\n• O Membro Fundador tem direito a comissão reduzida de 9% (nove por cento) sobre o valor do item nas vendas realizadas, pelo prazo de 6 (seis) meses contados da adesão, após o qual passa a valer a tabela de comissões vigente.\n• O programa pode conceder benefícios adicionais, como créditos de destaque de anúncios, conforme divulgado no momento da adesão.\n• As condições do programa (número de vagas, percentual, prazo e benefícios) são as vigentes na data da adesão e não retroagem a vendas anteriores. A Kolecta poderá encerrar novas adesões a qualquer momento, preservando os benefícios já concedidos aos Fundadores existentes.` },
  { id: 'responsabilidades', title: '10. Responsabilidades', content: `A Kolecta atua como intermediadora, facilitando o contato e a transação entre Compradores e Vendedores. A Kolecta não é proprietária dos Produtos anunciados, não os mantém em estoque e não participa da negociação direta entre as partes.\n\nO Vendedor é exclusivamente responsável pela qualidade, autenticidade, entrega e garantia dos Produtos vendidos. O Comprador é responsável por verificar as informações do anúncio antes de efetuar a compra.\n\nA Kolecta não garante a autenticidade de nenhum Produto anunciado, embora se empenhe em manter a qualidade do marketplace através de seus processos de verificação e moderação. Em caso de disputa, a Kolecta poderá mediar a resolução, mas a decisão final caberá às partes ou ao Poder Judiciário.` },
  { id: 'propriedade', title: '11. Propriedade intelectual', content: `Todo o conteúdo da Plataforma, incluindo mas não limitado a logotipos, marcas, layout, textos, código-fonte, design e funcionalidades, é de propriedade exclusiva da Kolecta ou de seus licenciadores, sendo protegido pela legislação brasileira de propriedade intelectual.\n\nAo publicar conteúdo na Plataforma (fotos, descrições, avaliações), o Usuário concede à Kolecta uma licença não exclusiva, gratuita, irrevogável e mundial para utilizar, reproduzir e exibir tal conteúdo no âmbito da Plataforma e em materiais de divulgação.\n\nÉ vedada a reprodução, cópia, modificação, distribuição ou utilização comercial de qualquer conteúdo da Plataforma sem autorização prévia e expressa da Kolecta.` },
  { id: 'privacidade', title: '12. Privacidade e dados', content: `A coleta, armazenamento e tratamento de dados pessoais dos Usuários são regidos pela nossa Política de Privacidade, disponível em kolecta.com.br/privacidade, que integra estes Termos de Uso.\n\nA Kolecta está comprometida com a proteção dos dados pessoais de seus Usuários, em conformidade com a Lei Geral de Proteção de Dados (LGPD — Lei nº 13.709/2018). Para mais informações sobre como tratamos seus dados, consulte nossa Política de Privacidade.` },
  { id: 'cancelamento', title: '13. Cancelamento e suspensão', content: `O Usuário poderá solicitar o cancelamento de sua conta a qualquer momento, através das configurações da Plataforma ou por contato com o suporte. O cancelamento não isenta o Usuário de obrigações pendentes, incluindo entregas em andamento, pagamentos devidos ou disputas abertas.\n\nA Kolecta poderá, a seu exclusivo critério, suspender temporariamente ou cancelar definitivamente contas de Usuários que violem estes Termos, pratiquem fraudes, recebam avaliações negativas recorrentes ou cujo comportamento represente risco à segurança da Plataforma ou de outros Usuários.\n\nEm caso de cancelamento por violação, a Kolecta poderá reter valores pendentes para fins de ressarcimento a terceiros prejudicados.` },
  { id: 'disposicoes', title: '14. Disposições gerais', content: `Estes Termos são regidos pelas leis da República Federativa do Brasil. Para dirimir quaisquer questões decorrentes destes Termos fica eleito o foro da Comarca de São Caetano do Sul/SP, ressalvado, nas relações de consumo, o direito do Comprador de ajuizar a demanda no foro de seu domicílio, nos termos do Código de Defesa do Consumidor.\n\nA Kolecta reserva-se o direito de alterar estes Termos a qualquer momento, mediante publicação da versão atualizada na Plataforma. As alterações entrarão em vigor a partir da data de publicação. O uso continuado da Plataforma após as alterações constitui aceitação tácita dos novos termos.\n\nSe qualquer disposição destes Termos for considerada inválida ou inexequível por qualquer tribunal competente, as demais disposições permanecerão em pleno vigor e efeito.\n\nA tolerância da Kolecta em relação ao descumprimento de qualquer cláusula destes Termos não constituirá renúncia ao direito de exigi-la a qualquer tempo.` },
];
    ...
    <Layout>
      <div className="max-w-[860px] mx-auto px-4 py-12">
        ...
        <div className="mb-10">
          ...
          <p className="text-sm text-muted-foreground mt-2">Última atualização: agosto de 2026</p>
          <Badge variant="outline" className="mt-2 text-xs">Versão 1.2</Badge>
        </div>
