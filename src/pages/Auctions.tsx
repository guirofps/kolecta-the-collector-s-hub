      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">{auctions.length} itens com lances ativos</p>
          </div>
        </div>
        ...
        {auctions.length === 0 ? (
          <div className="text-center py-20">
            ...
            <p className="font-heading text-xl font-bold text-muted-foreground uppercase">Nenhum item com lances ativos</p>
            <p className="text-sm text-muted-foreground mt-2">Volte em breve para novas oportunidades.</p>
          </div>
        ) : (
